...
const Hero = () => {
  return (
    <div className="w-full min-h-screen md:py-[100px] relative">
      {/* hero text */}
      <div className="py-14 md:px-8 px-4 font-archivoExpandedBold lg:text-[100px] text-4xl md:text-7xl leading-[90px] z-20 relative max-w-[1350px] mx-auto -space-y-12">
        <motion.h1
